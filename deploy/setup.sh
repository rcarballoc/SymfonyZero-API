...
SYMFONYPATH='/var/www/SymfonyZero-API'
BRANCH='master'
...
cp $SYMFONYPATH/deploy/symfonyzeroapi.conf /etc/apache2/sites-available/symfonyzeroapi.conf
sudo a2ensite symfonyzeroapi.conf
sudo service apache2 restart

#Add entry in /etc/hosts
printf "\n127.0.0.1\tapi.symfonyzero\n" >> /etc/hosts
